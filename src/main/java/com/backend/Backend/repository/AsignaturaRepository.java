...
public interface AsignaturaRepository  extends JpaRepository<Asignatura, Long>{
	...
	public List<Integer> getGrupos(@Param("nombre_plan") String nombre_plan, @Param("semestre")String semestre,
								   @Param("curso")int curso );
	@Query(value = "SELECT DISTINCT a.nombre FROM Asignatura a WHERE " +
			"a.nombre_plan = :nombre_plan AND  a.curso = :curso  AND  a.semestre = :semestre AND  a.grupo = :grupo   ",nativeQuery = true)
